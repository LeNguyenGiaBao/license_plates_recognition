...
def preprocess_image(image):
    # Kích thước lớn nhất và nhỏ nhất của 1 chiều ảnh (quy định của WPOD-NET??)
    Dmax = 608
    Dmin = 288
    ...
    processed_image = np.expand_dims(resized_image, 0)

    return processed_image, resized_image

# https://github.com/thangnch/MiAI_LP_Detection_SVM/blob/master/lib_detection.py#L133
class Label:
